...
from engine.options import FPS, CHUNK_SCALE, HEIGHT_SCALE, NUM_OCTAVES
...
class FollowTerrainPlayer:
    MAX_SPEED = 0.15 * CHUNK_SCALE # How many chunks per second
    MIN_SPEED = 0.0
    ...
    FORWARD_ACCELERATION = MAX_SPEED / (2 * FPS)
