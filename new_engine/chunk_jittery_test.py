...
BIOME_POINTS = {
    ...
    "plain": ((0.0, -0.3), (0.43, 0.0), (0.45, 0.01), (0.50, 0.15), (0.70, 0.21), (0.80, 0.67), (0.90, 0.82), (1.0, 1.0)), # plat
    ...
    "snowy": ((0.0, -0.3), (0.43, 0.0), (0.45, 0.01), (0.50, 0.15), (0.70, 0.21), (0.80, 0.67), (0.90, 0.82), (1.0, 1.0)), # plat enneigé
...
BIOME_COLORS = {
    ...
    "desert_dune": [(159, 240, 220), (199, 245, 230), # Water (very dark one...)
