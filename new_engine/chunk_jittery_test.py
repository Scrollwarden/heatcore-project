...
BIOME_POINTS = {
    ...
    "desert_dune": ((0.0, 0.1), (0.03, 0.115), (0.07, 0.085), (0.11, 0.11), (0.16, 0.09), (0.17, 0.07), (0.25, 0.11), (0.3, 0.1), # Wiggle around 0.1
...
BIOME_COLORS = {
    "plain": [( 21,  47,  88), ( 25,  54, 100), ( 33,  69, 120), ( 44,  87, 147), # Water
                       (245, 222, 154),  # Beach
                       (124, 162,  55), ( 89, 135,  51),  # Grass
                       ( 39,  39,  39), ( 67,  57,  47), ( 74,  62,  53), ( 79,  73,  68),  # Mountain
                       (255, 255, 255)],  # Peak

    "plateau": [( 21,  47,  88), ( 25,  54, 100), ( 33,  69, 120), ( 44,  87, 147), # Water
                       (245, 222, 154),  # Beach
                       (124, 162,  55), ( 89, 135,  51),  # Grass
                       ( 39,  39,  39), ( 67,  57,  47), ( 74,  62,  53), ( 79,  73,  68),  # Mountain
                       (255, 255, 255)],  # Peak
    
    "desert_dune": [(100, 219, 223), (128, 203, 212), (159, 240, 220), (199, 245, 230), # Water
                       (245, 222, 154),  # Beach
                       (238, 220, 162), (248, 222, 138),  # Sand
                       (219, 195, 114), (163, 147, 93), (138, 126, 87), (79,  73,  68),  # Mountain
                       (255, 255, 255)],  # Peak
    ...
    "snowy": [(41, 48, 87), (51, 65, 112), (87, 99, 138), (115, 134, 189), # Water
                       (245, 222, 154),  # Beach
                       (135, 175, 131), (148, 177, 146),  # Grass
                       (178, 179, 182), (197, 198, 201), (207, 207, 209), (134, 134, 134),  # Mountain
                       (214, 246, 248)],  # Peak

    "tundra": [(41, 48, 87), (51, 65, 112), (87, 99, 138), (115, 134, 189), # Water
                       (245, 222, 154),  # Beach
                       (135, 175, 131), (148, 177, 146),  # Grass
                       (178, 179, 182), (197, 198, 201), (207, 207, 209), (134, 134, 134),  # Mountain
                       (214, 246, 248)],  # Peak
    ...
    "archipel": [(100, 219, 223), (128, 203, 212), (159, 240, 220), (199, 245, 230), # Water
                       (245, 222, 154),  # Beach
                       (124, 162,  55), ( 89, 135,  51),  # Grass
                       (199, 245, 230), (159, 240, 220), (128, 203, 212), (100, 219, 223),  # Water again (inverted)
                       ( 39,  39,  39), ( 67,  57,  47), ( 74,  62,  53), ( 79,  73,  68),  # Mountain
                       (255, 255, 255)],  # Peak
...
BIOME_HEIGHTS_LIMIT = {
    "plain": [0.005, 0.25, 0.3, 0.35, 0.45, 0.525, 0.59, 0.68, 0.74, 0.79, 0.85],
    "plateau": [0.005, 0.25, 0.3, 0.35, 0.45, 0.525, 0.59, 0.68, 0.74, 0.79, 0.85],
    "desert_dune": [0.005, 0.25, 0.3, 0.35, 0.45, 0.525, 0.59, 0.68, 0.74, 0.79, 0.85],
    "desert_rock": [0.005, 0.25, 0.3, 0.35, 0.45, 0.525, 0.59, 0.68, 0.74, 0.79, 0.85],
    "snowy": [0.005, 0.25, 0.3, 0.35, 0.45, 0.525, 0.59, 0.68, 0.74, 0.79, 0.85],
    "tundra": [0.005, 0.25, 0.3, 0.35, 0.45, 0.525, 0.59, 0.68, 0.74, 0.79, 0.85],
    "archipel": [0.01, 0.35, 0.4, 0.5, 0.45, 0.525, 0.68, 0.7, 0.74, 0.79, 0.85, 0.9, 0.93, 0.96, 0.98],
    "natural_bastions": [0.005, 0.25, 0.3, 0.35, 0.45, 0.525, 0.59, 0.68, 0.74, 0.79, 0.85]
}
