...
BIOME_COLORS = {
    ...
    "desert_dune": [(159, 240, 220), (199, 245, 230), # Water
    ...
    "glaciers": [(100, 219, 223), (128, 203, 212), (159, 240, 220), (199, 245, 230), # Water
                       (214, 246, 248),  # Ice
                       (178, 179, 182), (207, 207, 209), (250, 250, 252), (255, 255, 255),  # Mountain
                       (214, 246, 248)]  # Peak
}
...
BIOME_HEIGHTS_LIMIT = {
    ...
    "snowy": [0.05, 0.2, 0.35, 0.45, 0.48, 0.6, 0.76, 0.79, 0.81, 0.84, 0.93],
    "tundra": [0.005, 0.25, 0.3, 0.32, 0.45, 0.525, 0.59, 0.68, 0.74, 0.79, 0.89],
    "archipel": [0.2, 0.35, 0.4, 0.5, 0.6, 0.7, 0.76, 0.81, 0.85, 0.9],
    "glaciers": [0.2, 0.35, 0.4, 0.45, 0.76, 0.78, 0.81, 0.85, 0.9]
}
