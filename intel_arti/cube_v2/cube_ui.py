...
from intel_arti.cube_v2.generators import GameSaver
...
NUM_MODEL = 1
GENERATION = 1
MODEL_PATH = os.path.join(os.path.abspath(__file__).rstrip("cube_ui.py"),
                          f"models/generation{GENERATION}/model{NUM_MODEL}.h5")
...
def create_shape_from_pos(pos_x, width=200):
    ...
    pos_y = SCREEN_HEIGHT
    return (Vector2(pos_x, pos_y - 140), Vector2(pos_x + width, pos_y - 140), Vector2(pos_x + width, pos_y - 10),
            Vector2(pos_x, pos_y - 10))
